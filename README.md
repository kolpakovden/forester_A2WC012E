...
> **Важно про имена файлов:** часть исторических BIN содержит `sg9` в имени. Это legacy-имя файлов, которое сохраняется ради происхождения и сопоставления старых логов.
