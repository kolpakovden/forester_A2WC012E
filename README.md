# A2WC012E ECU Tuning Knowledge Base

Практическая база знаний по исследованию и настройке Subaru ECU/ROM **A2WC012E**, собранная из реальных изменений, binary diff, логов и проверок на автомобиле.
